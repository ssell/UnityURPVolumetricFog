...
/**
 * Copy of Unity ShaderIDs which is private.
...
namespace VertexFragment
{
    ...
    {
        // ---------------------------------------------------------------------------------
        // Copied from Unity ShaderIDs which is private.
        // https://github.com/Unity-Technologies/Graphics/blob/ffa21b54c20545786dd5e691f58f41468f0c153a/com.unity.postprocessing/PostProcessing/Runtime/Utils/ShaderIDs.cs
        // ---------------------------------------------------------------------------------

        public static readonly int MainTex = Shader.PropertyToID("_MainTex");
        public static readonly int MainDepthTex = Shader.PropertyToID("_MainDepthTex");
        ...
        public static readonly int GrainNoiseParameters = Shader.PropertyToID("_NoiseParameters");
        ...
        public static readonly int DepthSlice = Shader.PropertyToID("_DepthSlice");
        public static readonly int UVScaleOffset = Shader.PropertyToID("_UVScaleOffset");
        public static readonly int PosScaleOffset = Shader.PropertyToID("_PosScaleOffset");

        // ---------------------------------------------------------------------------------
        // Misc Unity Internal
        // ---------------------------------------------------------------------------------

        public static readonly int Unity_GUIZTestMode = Shader.PropertyToID("unity_GUIZTestMode");
